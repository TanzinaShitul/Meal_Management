...
import com.tanzina.meal_management.adapter.ViewHolderCost;
...
public class CostActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerAdapter<Cost, ViewHolderCost> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Cost, ViewHolderCost>(Cost.class, R.layout.cost_list_layout, ViewHolderCost.class, databaseReference.child("mess").child(messId).child("cost")) {
            @Override
